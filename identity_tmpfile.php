...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $target_dir = "uploads/document/identity_card/";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
            $name = $_POST['name'];
            $ic = $_POST['icNo'];
            $identityFileName = $_POST['identityFileName'];
            $identityFilePath =  $target_file;
            
            $query = "INSERT INTO other_tmp_files (name, filepath, filename, ic_number) VALUES ('$name', '$identityFilePath', '$identityFileName', '$ic')";
