...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
            ...
            $query = "INSERT INTO tmp_files (filename, filepath) VALUES ('$filename', '$target_file')";
            if (mysqli_query($conn, $query)) {
                echo json_encode(array("message" => "File uploaded successfully.", "filename" => $filename, "filepath" => $target_file));
            } else {
